package com.zte.zakker.common.view;
...
import com.zte.zakker.common.util.MultiMediaUtil;
...
public class PhotoSelectDialog extends BottomSheetDialogFragment implements View.OnClickListener {
    ...
    public void onClick(View v) {
        ...
        if (i == R.id.btn_take_photo) {
            mPhotoPath = com.zte.zakker.common.util.MultiMediaUtil.getPhotoPath(getActivity());
            MultiMediaUtil.takePhoto(this, mPhotoPath, com.zte.zakker.common.util.MultiMediaUtil.TAKE_PHONE);
